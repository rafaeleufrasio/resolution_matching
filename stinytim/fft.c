...
*	Imaginary : Pointers an array containing the imaginary data.
*	Dim       : Dimension of Real and Imaginary (Dim x Dim).
...
void fft( complex *image, int ntot, int n, int nspan, int isn )
{
/*----------------------------------------------------------------------
 ...
 * (this seems to work on every machine tested so far...)                      */
